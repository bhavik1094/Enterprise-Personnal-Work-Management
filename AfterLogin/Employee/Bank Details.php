...
<html>
    ...
    <body>
        ...
        $sql = mysqli_query($con, "select emp_id from employeemaster where emp_email='$user'");
            ...
            <div class="bank-form">
                ...
                <div class="bank-form-content">
                    <form method="post">
                        <div class="row">
                            <?php
                            $res = mysqli_query($con, "select * from bank_details where id='$employeeId'");
                        ...
                        <form method="post">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="bankEditIfsc" class="form-control" placeholder="<?php echo $bankIfsc; ?>" value=""/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="empEditName" class="form-control" placeholder="<?php echo $empBankName; ?>" value=""/>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="bankEditAccountNo" class="form-control" placeholder="<?php echo $accNo; ?>" value=""/>
                                    </div>
                                </div>
                            </div>
        ...
        if (isset($_POST['btnEditBankSubmit'])) {
            ...
            $update = mysqli_query($con, "UPDATE bank_details SET bank_name='$bankEditName', bank_ifsc='$bankEditIfsc', emp_bank_name='$empEditBankName', bank_acc_no='$accEditNo' where emp_id='$employeeId'");
            if ($update) {
