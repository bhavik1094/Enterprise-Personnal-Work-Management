                    ...
                    <div class="table-responsive">
                        <form method="get">
                            <table class="table">
                                ...
                                <tbody id="myTable">
                                    <?php
                                    $sql = mysqli_query($con, "select * from notes_master where status='EtoC' and client_id='$client_id'");
                    ...
                    <div class="table-responsive">
                        <form method="get">
                            <table class="table">
                                ...
                                <tbody id="myTable">
                                    <?php
                                    $sql = mysqli_query($con, "select * from notes_master where status='EtoC' and bookmark='Yes' and client_id='$client_id'");
                                    while ($row = mysqli_fetch_array($sql)) {
                                        $note_proj_id = $row['project_id'];
                                        echo "<tr>";
                                        echo "<td>" . $row['project_id'] . "</td>";
                    ...
                    <div class="table-responsive">
                        <form method="get">
                            <table class="table">
                                ...
                                <tbody id="myTable">
                                    <?php
                                    $sql = mysqli_query($con, "select * from notes_master where status='CtoE' and client_id='$client_id'");
                                    while ($row = mysqli_fetch_array($sql)) {
                                        $note_proj_id = $row['project_id'];
                                        echo "<tr>";
                                        echo "<td>" . $row['project_id'] . "</td>";
...
//            $sql = mysqli_query($con, "update notes_master set bookmark='Yes' where project_id='$note_proj_id'");
//            if($sql){
//                echo "true";
//            }
//        }
