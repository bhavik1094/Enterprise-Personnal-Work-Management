...
<html>
    ...
    <body>
            ...
            <div class="project-content">
                ...
                <div class="about-details">
                    <div class="row">
                        ...
                        <input type="submit" name="btnApply" value="Hire Now"/>
                    </div>
                <?php } ?>
            </div>
            </form>
        ...
        if (isset($_POST['btnApply'])) {
            $answers = mysqli_query($con, "select * from projectmaster where project_id='$pId'");
            while ($row = mysqli_fetch_array($answers)) {
                $cId = $row['client_id'];
                $cName = $row['employer_name'];
                $end_date = $row['end_date'];
            }
            $status = "Active";
            $start_date = date("Y-m-d");

            $hire = mysqli_query($con, "insert into current_working_projects values('$pId','$projName','$cId','$cName','$eId','$eName','$status','$start_date','$end_date')");
            if ($hire) {
                echo "<script>alert('You hired this emoloyee')</script>";
                mysqli_query($con,"delete from project_application_master where project_id='$pId'");
